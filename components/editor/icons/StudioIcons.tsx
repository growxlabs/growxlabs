...
// ----------------------------------------------------
// VIDEO, CAMERA & MULTIMEDIA RECORDING
// ----------------------------------------------------


export const Camera = (props: StudioIconProps) =>
  base(
    props,
    <>
...
export const Mic = (props: StudioIconProps) =>
  base(
    props,
    <>
...
export const MicOff = (props: StudioIconProps) =>
  base(
    props,
    <>
      <line x1="2" x2="22" y1="2" y2="22" />
...
export const Pause = (props: StudioIconProps) =>
  base(
    props,
    <>
...
export const Send = (props: StudioIconProps) =>
  base(
    props,
    <>
...
export const ArrowRight = (props: StudioIconProps) =>
  base(
    props,
    <>
...
export const AlertCircle = (props: StudioIconProps) =>
  base(
    props,
    <>
      <circle cx="12" cy="12" r="10" />
...
export const Radio = (props: StudioIconProps) =>
  base(
    props,
    <>
...
export const Globe = (props: StudioIconProps) =>
  base(
    props,
    <>
      <circle cx="12" cy="12" r="10" />
