...
export async function renderConsultingInvoicePdf(data: ConsultingInvoiceDocumentData): Promise<Buffer> {
  ...
  const milestoneName = clean(instructions.milestoneDescription || line.description || `Payment stage ${Number(instructions.milestoneIndex || 0) + 1}`);
