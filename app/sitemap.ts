...
const blogRoutes = [
  ...
  { path: '/blog/cursor-origin-github-ai-code-hosting', priority: 0.9, changefreq: 'daily' as const },
  { path: '/blog/stripe-openrouter-ai-infrastructure-acquisition', priority: 0.9, changefreq: 'daily' as const },
