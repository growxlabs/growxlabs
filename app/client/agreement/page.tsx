...
const clientStatusLabels: Record<string, string> = { sent: "Ready for review", viewed: "Ready for review", signing: "Awaiting final signature", signed: "Signed by both parties", client_changes_requested: "Changes requested" };
const label = (value: string) => clientStatusLabels[value] || value.replaceAll("_", " ").replace(/\b\w/g, (character) => character.toUpperCase());
